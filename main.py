...
def pedir_informacoes():
    ...
    while ((opcao != 1 and opcao != 2)):
        opcao = int(input(
            'Digite o número da opção escolhida para o formato que você quer fornecer o nome:\n1 - Arquivo CSV\n2 - Digitar os nomes\n'))
        ...
        if opcao == 1:
            ...
            contatos = input(
                "Digite os nomes exatamente como estão salvos nos contatos separados por ,\nExemplo: Arthur Brito Medeiros,Pedro Medeiros,Isabela Campelo\n")
    ...
    while ((opcao_mensagem != 1 and opcao_mensagem != 2 and opcao_mensagem != 3)):
        ...
        if opcao_mensagem == 1:
            ...
            with open("number_msg_send.txt", "a") as myfile:
                myfile.write(
                    f"Número de mensagens enviadas: {bot2.count_mensagens}\n")
            break
